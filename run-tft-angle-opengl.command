...
export TFT_RENDERER="${TFT_RENDERER:-angle}"
export TFT_GRAPHICS_PROFILE="${TFT_GRAPHICS_PROFILE:-osft}"
export TFT_CPU_CORES="${TFT_CPU_CORES:-8}"
export TFT_MEMORY_MB="${TFT_MEMORY_MB:-8192}"
export TFT_DISPLAY_SIZE="${TFT_DISPLAY_SIZE:-1920x1080}"
export TFT_DISPLAY_DENSITY="${TFT_DISPLAY_DENSITY:-280}"
